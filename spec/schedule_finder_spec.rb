...
describe ScheduleFinder do
  ...
  describe "when finding combinations of possible courses" do
    ...
    describe "when providing a single course" do
      let(:period_1_5) { Period.on("friday").from("6h00").to("7h00") }
      let(:group_5) { Group.new(5).with period_1_5 }
      let(:group_7) { Group.new(7) }
      let(:period_1_8) { Period.on("monday").from("6h00").to("7h00") }
      let(:period_2_8) { Period.on("monday").from("9h00").to("10h00") }
    ...
    describe "when providing multiple courses" do
      # COM110
      let(:period_1_1_1) { Period.on("thursday").from("9h00").to("12h30") }
      let(:period_2_1_1) { Period.on("tuesday").from("8h30").to("12h30") }
      let(:group_1_1) { Group.new(1).with period_1_1_1, period_2_1_1 }

      let(:period_1_2_1) { Period.on("wednesday").from("9h00").to("12h30") }
      let(:period_2_2_1) { Period.on("monday").from("8h30").to("12h30") }
      let(:group_2_1) { Group.new(2).with period_1_2_1, period_2_2_1 }

      let(:period_1_3_1) { Period.on("monday").from("18h00").to("21h30") }
      let(:period_2_3_1) { Period.on("wednesday").from("18h00").to("22h00") }
      let(:group_3_1) { Group.new(3).with period_1_3_1, period_2_3_1 }

      let(:period_1_4_1) { Period.on("wednesday").from("13h30").to("17h00") }
      let(:period_2_4_1) { Period.on("friday").from("8h30").to("12h30") }
      let(:group_4_1) { Group.new(4).with period_1_4_1, period_2_4_1 }

      let(:period_1_5_1) { Period.on("thursday").from("18h00").to("21h30") }
      let(:period_2_5_1) { Period.on("tuesday").from("18h00").to("22h00") }
      ...
      # LOG320
      let(:period_1_1_2) { Period.on("friday").from("13h00").to("17h00") }
      let(:period_2_1_2) { Period.on("tuesday").from("13h00").to("17h00") }
      let(:group_1_2) { Group.new(1).with period_1_1_2, period_2_1_2 }

      let(:course_2) { Course.new("LOG320").with group_1_2 }

      # LOG330
      let(:period_1_1_3) { Period.on("thursday").from("18h00").to("21h00") }
      let(:period_2_1_3) { Period.on("friday").from("18h00").to("20h00") }
      let(:group_1_3) { Group.new(1).with period_1_1_3, period_2_1_3 }

      let(:period_1_2_3) { Period.on("monday").from("18h00").to("21h00") }
      let(:period_2_2_3) { Period.on("tuesday").from("9h00").to("12h00") }
      let(:group_2_3) { Group.new(2).with period_1_2_3, period_2_2_3 }

      let(:course_3) { Course.new("LOG330").with group_1_3, group_2_3 }

      # GIA400
      let(:period_1_1_4) { Period.on("tuesday").from("18h00").to("21h00") }
      let(:period_2_1_4) { Period.on("friday").from("9h00").to("12h00") }
      let(:group_1_4) { Group.new(1).with period_1_1_4, period_2_1_4 }

      let(:period_1_2_4) { Period.on("friday").from("13h00").to("17h00") }
      let(:period_2_2_4) { Period.on("monday").from("13h00").to("17h00") }
      let(:group_2_4) { Group.new(2).with period_1_2_4, period_2_2_4 }

      let(:period_1_3_4) { Period.on("wednesday").from("9h00").to("12h00") }
      let(:period_2_3_4) { Period.on("monday").from("9h00").to("12h00") }
